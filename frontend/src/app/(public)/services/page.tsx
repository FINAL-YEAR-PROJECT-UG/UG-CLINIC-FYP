...
import ugCompoundBg from '@/Assets/Legon UG/university-of-ghana-compound.jpg';
import {
  Stethoscope,
  Heart,
  ShieldAlert,
      ...
      <div className="relative">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center mb-12">
            ...
            <p className="text-xs font-medium text-[#0369A1] mt-1.5 flex items-center justify-center gap-1.5 flex-wrap">
              <span>Note: Dental checkups and optical procedures are only available at the Main UG Hospital.</span>
              <a
                href="https://www.google.com/maps?q=5.65145873649435,-0.17833193194224153"
                target="_blank"
                rel="noreferrer"
                className="underline font-bold text-[#1e3a8a] hover:text-[#0F172A] inline-flex items-center gap-0.5"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {services.map((svc) => {
              ...
              return (
                <div
                  key={svc.id}
                  className="bg-white/92 backdrop-blur-md border border-white/80 rounded-2xl p-6 shadow-sm hover:shadow-[0_16px_40px_-8px_rgba(15,23,42,0.16)] hover:-translate-y-1.5 hover:border-blue-200 transition-all duration-300 flex flex-col justify-between"
                >
                  <div>
        ...
        <section className="bg-gradient-to-br from-[#0F172A]/95 via-[#1e3a8a]/95 to-[#0369A1]/95 backdrop-blur-md text-white py-16 px-4 sm:px-6 lg:px-8 shadow-lg">
        ...
        <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="space-y-4">
            {faqs.map((faq) => (
              <div key={faq.title} className="bg-white/92 backdrop-blur-md rounded-2xl border border-white/80 p-6 shadow-sm">
                <div className="flex items-center justify-between mb-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs mb-5 bg-[#F5F7FB]/90 p-4 rounded-xl border border-[#DDE3EE]">
          ...
          <div className="relative z-10 max-w-4xl mx-auto">
            ...
            <div className="bg-white/92 backdrop-blur-md rounded-2xl border border-white/80 overflow-hidden shadow-sm">
              ...
              <div className="divide-y divide-[#DDE3EE]">
                {schedule.map((row) => (
                  <div key={row.day} className="grid grid-cols-3 px-5 py-3 text-xs items-center bg-white/70">
            ...
            <div className="mt-10 text-center">
              <Link
                href="/demo-booking"
                className="inline-flex items-center justify-center gap-2 px-5 sm:px-8 py-2.5 sm:py-3.5 rounded-xl font-bold text-xs sm:text-sm text-[#0F172A] bg-white shadow-[0_4px_20px_rgba(255,255,255,0.25)] hover:bg-blue-50 hover:shadow-[0_8px_30px_rgba(255,255,255,0.35)] hover:-translate-y-0.5 transition-all duration-200"
              >
